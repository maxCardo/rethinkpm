...
const emailTemplate = (properties, message) => {
  ...
  console.log('generating templet new temp');
  const propertyTemplate = properties.map(property => {
      return `<div style="background-color:transparent;overflow:hidden" class="recommendedProperty">
                <div class="block-grid two-up" style="min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; width: 100%; background-color: #ffffff;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;">
                        <div class="col num6" style="display: table-cell; vertical-align: middle; max-width: 220px; min-width: 200px; width: 200px;">
                        ...
                        <div class="col num6" style="display: table-cell; vertical-align: middle; max-width: 420px; min-width: 400px; width: 400px;">
                            <div style="width:100% !important;">
                                    ...
                                    <div style="color:#27496d;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.2;padding-top:5px;padding-right:5px;padding-bottom:5px;padding-left:5px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #27496d; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 24px; text-align: center; line-height: 1.2; word-break: break-word; mso-line-height-alt: 29px; margin: 0;">
                                                <span style="font-size: 24px;">Look at these options</span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if mso]>
