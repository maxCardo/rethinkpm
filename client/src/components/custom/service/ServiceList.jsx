    ...
    activity: [
      {
        Date: '1/1/2019',
        activity:
          'Terrence Denne selected as vendor and email sent to dennehandyman@gmail.com',
      },
    ],
  },
};
      ...
      <table className="table table-striped">
        ...
        <tbody>
          <tr>
            ...
            <td>
              {tempData.tenant.unitNum
                ? tempData.tenant.property + ' - ' + tempData.tenant.unitNum
                : tempData.tenant.property}
            </td>
